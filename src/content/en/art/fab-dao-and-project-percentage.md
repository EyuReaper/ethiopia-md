...
# The Perpetual Donation Engine: FAB DAO and Project % Social Experiment
...
FAB DAO's core philosophy can be summarized in one phrase: "donation as collection." In traditional philanthropy models, donations are one-time consumptive acts—once the money is given, it's gone forever. But in FAB DAO's design, donors receive not just thank-you letters, but tradeable NFTs with artistic value. What does this mean? It means philanthropy now has the potential to become a "perpetual engine."
...
Project %'s fund allocation demonstrates sophisticated social design thinking: 20% for preliminary costs, 10% for artist fees, 10% to assist other NPO-NFT projects, 20-45% for public procurement funds, and 10-15% for DAO technical development.

This allocation logic implies an important conceptual shift: artistic creation moves from personal expression to collective action, from artwork sales to social investment. When you collect a Project % NFT, you're buying not just an artwork, but shares in a social vision.

More interestingly, collecting multiple Project % NFTs triggers visual interaction easter eggs. This seemingly simple technical design actually tests collectors' depth of participation. It asks: are you a passing speculator or a long-term participant who believes in this experiment?
...
Perhaps FAB DAO and Project %'s deepest contribution lies in redefining the logic of value creation. In traditional economic models, value creation often means competition and exclusivity: your gain is my loss, resources are limited, distribution is zero-sum.
...
Looking back at FAB DAO and Project % today, we see not just a successful Web3 philanthropy experiment, but an imagination of future society. In this imagination, art is no longer elite privilege but a tool for social change; philanthropy no longer relies on charitable attitudes but is built on shared interests; technology is no longer just a means of commercial competition but a driver of social innovation.

Of course, such experiments also face challenges. The complexity of blockchain technology remains a barrier for ordinary citizens' participation; NFT market volatility may affect philanthropic fund stability; and decentralized governance efficiency issues require continuous improvement.

But just as Huang Dou-ni once decided to leave the hospital and pick up a paintbrush, genuine innovation often requires courage to face the unknown. The value of FAB DAO and Project % lies not in providing perfect solutions but in opening new possibilities.

On this island, one hundred mountains rise upward, and one hundred dreams are sprouting. Each of us can choose to become a participant in this social experiment, writing the next chapter of civilization in our own way.
...
4. ABMedia Chain News Report (2022/06): https://abmedia.io/20220630-charity-dao-fab-dao-project
5. ARTouch Ars Electronica Interview (2023/03): https://artouch.com/art-market/content-84864.html
6. c2x3 Blockchain Art Media Matters Introduction (2022/07): https://matters.town/a/fe3n38t5khdb
7. Technology Charm Feature: https://www.charmingscitech.nat.gov.tw/post/art_tech_nft_block_chain
8. NFT Network News Report: https://nft.org.tw/?p=20219
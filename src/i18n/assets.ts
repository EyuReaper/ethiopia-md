...
<img src="https://ethiopia.md/assets/svg/ethiopia-icon-wiki.svg" alt="Ethiopia" width="200">

<!-- As CSS background -->
background-image: url('https://ethiopia.md/assets/svg/ethiopia-icon-wiki.svg');

<!-- In Markdown -->
![Ethiopia](https://ethiopia.md/assets/svg/ethiopia-icon-wiki.svg)`,
  ...
  am: {
    ...
    'assets.btn.copy': 'የSVG ኮድ ቅዳ',

    // Usage section
    'assets.usage.title': '📝 አጠቃቀም (How to Use)',
    'assets.usage.code': `<!-- Embed directly -->
<img src="https://ethiopia.md/assets/svg/ethiopia-icon-wiki.svg" alt="Ethiopia" width="200">
...
![Ethiopia](https://ethiopia.md/assets/svg/ethiopia-icon-wiki.svg)`,
    ...
    // Script messages
    'assets.script.copied': '✅ ተቀድቷል',
    'assets.script.failed': '❌ አልተሳካም',
  },
} as const;

...
3. **User references a specific topic** (e.g., "[Amharic translation needed - original Taiwan context]", "TSMC", "228 incident") — find the authoritative article
...
| Command             | Description                                  |
| ------------------- | -------------------------------------------- |
| `search <query>`    | Fuzzy search ([Amharic translation needed - original Taiwan context])                      |
...
node cli/src/index.js search "[Amharic translation needed - original Taiwan context]" --json --limit 3

# 2. Read the most relevant one
node cli/src/index.js read "[Amharic translation needed - original Taiwan context]" --raw
...
- Articles are in Traditional Chinese (am) as the source of truth
